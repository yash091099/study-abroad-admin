...
const UserInnerDetailsPersonal: FunctionComponent = () => {
  return (
    // <div className="w-full relative bg-whitesmoke-200 h-[107.125rem] overflow-hidden text-left text-[1.5rem] text-gray1-200 font-semi-bold-11">
    ...
    //     />
        <div className="w-[88.313rem] flex flex-col items-start justify-start py-[1rem] px-[0rem] box-border gap-[1.5rem]">
          ...
          />
          <div className="self-stretch rounded-2xl bg-white shadow-[0px_4px_18px_rgba(75,_70,_92,_0.1)] flex flex-col items-start justify-start py-[4rem] px-[2.5rem] gap-[2rem]">
            <div className="relative font-semibold">Edgar Jones</div>
            <UserInfoCard />
          </div>
        </div>
//       </div>
//       <div className="absolute top-[100.25rem] left-[29.25rem] rounded-md w-[80.813rem] h-[3rem] overflow-hidden flex flex-row items-end justify-center py-[0.75rem] px-[0rem] box-border text-[0.938rem] font-light-button-2-button-default">
...
export default UserInnerDetailsPersonal;
