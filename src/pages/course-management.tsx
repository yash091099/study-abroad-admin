...
const data = [
  { name: 'Maths 101', duration: '2 Years', major: 'Mathematics', lastDate: 'March 15, 2024', scholarship: 'NASCOM', avatarUrl: '/avatar1@2x.png', instituteName: 'Institute Name' },
...
const columns = [
  {
    ...
    header: 'Name',
    width: 'w-1/4',
    render: (item: { name: string; avatarUrl: string }) => (
      <>
        <img src={item.avatarUrl} alt="" className="h-8 w-8 rounded-full object-cover mr-2" />
        <span>{item.name}</span>
      </>
    )
  },
  { key: 'duration', header: 'Duration', width: 'w-1/4' },
  { key: 'major', header: 'Major', width: 'w-1/4' },
  { key: 'lastDate', header: 'Last Date', width: 'w-1/4' },
  { key: 'scholarship', header: 'Scholarship', width: 'w-1/4' },
  // Additional columns can be configured here
];

const CourseManagement: FunctionComponent = () => {
  return (
    <div className="overflow-hidden self-stretch rounded-lg bg-white shadow-[0px_4px_18px_rgba(75,_70,_92,_0.1),_0px_2px_4px_rgba(165,_163,_174,_0.3)] flex flex-col items-start justify-start p-[2rem] gap-[1.5rem] lg:self-stretch lg:w-auto lg:gap-[1.5rem] lg:rounded-lg">
      <div className="self-stretch flex flex-row items-center justify-start gap-[2.125rem] sticky top-0 bg-white z-10">
        <div className="flex-1 relative font-semibold">Course Management</div>
      ...
      <div className="table-content flex flex-col items-start justify-start text-[0.938rem] font-light-button-2-button-default overflow-auto overflow-x-scroll w-[100%]">
