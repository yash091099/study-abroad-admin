...
import AdminSideDashboard from "../components/admin-side-dashboard";
import Footer from "../components/footer";

const MainAdminScreen: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-whitesmoke-200 h-[131.563rem] overflow-hidden text-left text-[0.938rem] text-white font-light-button-2-button-default">
      <div className="absolute top-[0rem] left-[0rem] w-[120rem] flex flex-row items-start justify-start gap-[2rem]">
        <SideMenu
          sideMenuWidth="22.5rem"
          sideMenuHeight="131.563rem"
        ...
        />
        <div className="w-[92rem] flex flex-col items-center justify-center py-[1rem] px-[0rem] box-border gap-[1.5rem]">
          <div className="self-stretch rounded-md bg-white shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] overflow-hidden flex flex-row items-start justify-center py-[0.75rem] px-[1.5rem] gap-[0.625rem]">
            <div className="self-stretch flex-1 flex flex-row items-center justify-start gap-[0.625rem]">
              <img
                className="w-[1.625rem] relative h-[1.625rem]"
                alt=""
                src="/search.svg"
              />
              <div className="flex-1 relative leading-[1.375rem] text-transparent !bg-clip-text [background:linear-gradient(rgba(255,_255,_255,_0.5),_rgba(255,_255,_255,_0.5)),_#4b465c] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                Search (Ctrl+/)
              </div>
            </div>
            <div className="flex flex-row items-center justify-center gap-[2rem] font-noto-sans">
              <div className="w-[0.063rem] relative box-border h-[3.563rem] border-r-[1px] border-solid border-black" />
              <img
                className="w-[1.5rem] relative h-[1.5rem] overflow-hidden shrink-0"
                alt=""
                src="/bell.svg"
              />
              <div className="w-[2rem] relative h-[2rem]">
                <div className="absolute top-[0rem] left-[0rem] rounded-[50%] bg-slategray-200 w-[2rem] h-[2rem]" />
                <div className="absolute top-[0.313rem] left-[0.688rem] leading-[1.375rem]">
                  A
                </div>
              </div>
            </div>
