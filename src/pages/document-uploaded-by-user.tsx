...
import UserDocumentForm from "../components/user-document-form";

const DocumentUploadedByUser: FunctionComponent = () => {
  return (
    // <div className="w-full relative bg-whitesmoke-200 h-[72.5rem] overflow-hidden text-left text-[1.5rem] text-gray1-200 font-semi-bold-11">
    //   <div className="absolute top-[0rem] left-[0rem] w-[119rem] h-[72.5rem] flex flex-row items-start justify-start gap-[2.063rem]">
    //     <SideMenu
    //       sideMenuWidth="22.5rem"
    //       sideMenuHeight="84.563rem"
    ...
    //     />
        <div className="w-[92rem] flex flex-col items-start justify-start py-[1rem] px-[0rem] box-border gap-[1.5rem]">
          <Navbar1
            search="/search.svg"
            bell="/bell.svg"
          ...
          <div className="self-stretch rounded-2xl bg-white shadow-[0px_4px_18px_rgba(75,_70,_92,_0.1)] flex flex-col items-start justify-start py-[4rem] px-[2.063rem] gap-[2rem]">
            ...
            <div className="self-stretch rounded-md flex flex-row items-start justify-start gap-[1.25rem]">
              <UserInfoSidebar
                users="/users.svg"
                ...
                iconBackgroundColor="#ff6477"
                fileText1="/filetext1.svg"
              />
...
export default DocumentUploadedByUser;
