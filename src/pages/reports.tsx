...
const Reports: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-whitesmoke-200 h-[103.188rem] overflow-hidden text-left text-[0.938rem] font-noto-sans">
      <div className="absolute top-[-0.125rem] left-[0rem] flex flex-row items-start justify-start gap-[2rem]">
        <SideMenu
        ...
        <div className="w-[92rem] flex flex-col items-center justify-center py-[1rem] px-[0rem] box-border gap-[1.5rem]">
          ...
          <div className="w-[64.188rem] rounded-md h-[3rem] overflow-hidden shrink-0 flex flex-row items-center justify-center py-[0.75rem] px-[0rem] box-border">
