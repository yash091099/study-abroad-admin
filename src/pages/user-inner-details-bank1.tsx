...
import UserTestForm from "../components/user-test-form";

const UserInnerDetailsBank1: FunctionComponent = () => {
  return (
    ...
    //   <div className="absolute top-[0rem] left-[0rem] w-[116.5rem] h-[72.5rem] flex flex-row items-start justify-start gap-[2rem]">
    //     <SideMenu
...
export default UserInnerDetailsBank1;
