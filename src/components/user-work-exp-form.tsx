...
const UserWorkExpForm: FunctionComponent = () => {
  return (
    <div className="w-[67.125rem] flex flex-col items-start justify-start p-[1.5rem] box-border gap-[4rem] text-left text-[1.375rem] text-darkgray-200 font-light-button-2-button-default">
      <div className="w-[66.25rem] flex flex-col items-start justify-start">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[1.25rem] text-[1.125rem]">
            <div className="self-stretch flex flex-row items-start justify-start gap-[1.25rem]">
              <div className="flex-1 overflow-hidden flex flex-row items-center justify-between py-[0rem] pr-[1.25rem] pl-[0rem]">
                ...
                <div className="w-[21rem] rounded-md box-border flex flex-row items-center justify-start text-[0.938rem] border-[1px] border-solid border-gainsboro-100">
              ...
              <div className="flex-1 overflow-hidden flex flex-row items-center justify-between py-[0rem] pr-[1.25rem] pl-[0rem]">
                ...
                <div className="w-[21rem] rounded-md box-border flex flex-row items-center justify-start text-[0.938rem] border-[1px] border-solid border-gainsboro-100">
                  <div className="w-[21rem] rounded-md box-border flex flex-row items-center justify-start border-[1px] border-solid border-gainsboro-100">
                    <div className="w-[27.25rem] rounded-md overflow-hidden shrink-0 flex flex-row items-center justify-start py-[0.438rem] px-[0.875rem] box-border">
                      <div className="flex-1 relative leading-[1.5rem]">
                        Enter Board name
                      </div>
                    </div>
