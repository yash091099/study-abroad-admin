...
const Navbar: FunctionComponent = () => {
  return (
    <section className="self-stretch rounded-md bg-white shadow-[0px_2px_4px_rgba(165,_163,_174,_0.3)] overflow-hidden flex flex-row items-start justify-start py-[0.75rem] px-[1.5rem] box-border gap-[0.625rem] max-w-full text-left text-[0.938rem] text-white font-light-button-2-button-default mq1350:flex-wrap">
      ...
      <div className="flex-1 flex flex-col items-start justify-start pt-[1.063rem] px-[0rem] pb-[0rem] box-border min-w-[51.125rem] max-w-full mq900:min-w-full">
